...
### It is a copy of [ssvc-calc-mf](https://github.com/fruehaufm/SSVC/tree/main/ssvc-calc-mf) for visualization purposes and was originally forked from [here](https://github.com/CERTCC/SSVC/).
